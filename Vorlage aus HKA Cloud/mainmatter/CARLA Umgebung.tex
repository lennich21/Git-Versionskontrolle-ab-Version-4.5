...
\begin{figure}[h!]
	\begin{center}
		...
		\caption{Darstellung der Daten in , Quelle: \cite{lit_software_carla}, \cite{lit_software_canva}} \label{fig:carla_hud}
	\end{center}
\end{figure}
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption{Darstellung der textbasierten Daten in , Quelle: \cite{lit_software_carla}, \cite{lit_software_canva}} \label{fig:carla_hud_2}
	\end{center}
\end{figure}
