...
\begin{figure}
	\begin{center}
		...
		$\beta$ - Winkel zwischen Blickrichtung von 0° und Pfeil b.)} \label{fig:kruemmungsproblem_2}
	\end{center}
\end{figure}
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption{Visualisierung V-Korrekturfunktion, Quelle: \cite{lit_software_matlab}} \label{fig:imag11}
	\end{center}
\end{figure}
