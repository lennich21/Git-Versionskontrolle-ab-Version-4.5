...
\begin{figure}
	\begin{center}
		...
		\end{tikzpicture}
		\caption{Visualisierung der verzerrenden Wirkung einer gekrümmten Leinwand auf die Ergebnisse des Eye Trackers\\\\
		\footnotesize grauer Punkt - Sitzposition der Testperson\\
		a.) - Direkte Blickrichtung der Person mit einem Winkel von 0° auf die Mitte der Leinwand\\
		b.) - Blick nach links auf den äußeren linken Rand der imaginären flachen Leinwand\\
		c.) - Blick nach links auf den äußeren linken Rand der realen gekrümmten Leinwand}
...
\begin{figure}
	\begin{center}
		...
		\footnotesize grauer Punkt - Sitzposition der Testperson\\
		a.) - Blickrichtung von 90° nach links auf den äußeren linken Rand der realen gekrümmten Leinwand\\
		b.) - Transformation von Pfeil a.) auf die imaginäre flache Leinwand\\
		c.) - Blick nach links auf die realen gekrümmten Leinwand\\
		d.) - Transformation von Pfeil b.) auf die imaginäre flache Leinwand\\
