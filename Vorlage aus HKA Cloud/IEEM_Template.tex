...
<<<<<<< HEAD
% Stellt sicher, dass die Tabellen absolut gezählt werden und die Nummerierung nicht am aktuellen Kapitel abhängig gemacht wird.
...
% TIME FRAME
<<<<<<< HEAD
\timeframe{01.11.2024 - 10.06.2025} % Delete for dissertations
\submissiondate{10. Juni 2025}
=======
\timeframe{01.11.2024 - 01.06.2025} % Delete for dissertations
\submissiondate{Juni 2025}
>>>>>>> fd0befd8e95e2bae230d21ece8a1862eada6b577
...
% Ein Bugfix. Irgendein Paketkonflikt schafft Probleme beim Verwenden des acronym Paketes. Fix stammt von: https://tex.stackexchange.com/questions/737204/problem-with-amsmath-cleveref-acronym-continued
\makeatletter
\AtBeginDocument
{
...
\begin{document}
	...
	\frontmatter
	\maketitle
	%\acknowledge{\input{frontmatter/acknowledgement}}
	\abstract{\input{frontmatter/abstract}}
	\zusammenfassung{\input{frontmatter/zusammenfassung}}
%	\publications{\input{frontmatter/publications}}
%	\furtherpublications{\input{frontmatter/furtherpublications}}
	\tableofcontents
	...
	\mainmatter
	\input{mainmatter/Einfuehrung}
	\input{mainmatter/EyeTracker}
	\input{mainmatter/Implementierung Eye Tracker}
	\input{mainmatter/CARLA Umgebung}
	\input{mainmatter/Korrektur gekrümmte Leinwand}
	\input{mainmatter/Auswertung}
	...
	\abbrevations{\input{backmatter/abbreviations}}
	\input{backmatter/glossar}
	
	\symbollist{\input{backmatter/symbols}}
