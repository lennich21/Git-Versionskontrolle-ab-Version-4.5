...
In Abbildung \ref{fig:imag6} ist zu erkennen, wie sich der Korrekturwert bei einer Leinwand mit 4444 Pixeln Breite bezogen auf die jeweiligen Pixel verhält. Der zusätzlich hinzugekommene Korrekturfaktor für die rechte Leinwandhälfte $p_{k,r}$ sorgt dafür, dass die Korrektur auf der rechten Hälfte stärker ausgeprägt ist. 
